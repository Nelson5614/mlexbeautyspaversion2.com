                ...
                <div class="col-12">
                    <div class="page-title"> 
                        ...
                        <ul class="nav"> 
                            ...
                            <li class="active">Body Service</li>
                        </ul> 
                    </div>
                </div>
            </div>
            ...
            <div class="row align-items-center">
                <div class="col-md-8">
                    ...
                    <div class="section-title">
                        ...
                        <p>Our Body service with a scientific machines are the best in town</p>
                    </div>
                    <!-- End Section Title -->
                </div>
                                    ...
                                    <div class="beautain-select">
                                        <div class="input-group style--two">
                                            <select name="aa_service" id="appointment-treatment" class="form-control">
                                                ...
                                                <option value="Virginal Tightning">Virginal Tightning</option>
