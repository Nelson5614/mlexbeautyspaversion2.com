<?php
set_include_path(get_include_path() . PATH_SEPARATOR . 'C:\xampp\htdocs\MpesapaymentGateway');
...
// Api key
$context->set_api_key('7iaRR6mEhHt6AKjtzyQVlW5MSr5iwTxv');
// Public key
...
// API Path
$context->set_path('/sandbox/ipg/v2/vodacomLES/getSession/');
...
$context->set_address('openapi.m-pesa.com');
$context->set_port(443);
$context->set_path('/sandbox/ipg/v2/vodacomLES/queryBeneficiaryName/');

$context->add_header('Origin', '*');

$context->add_parameter('input_CustomerMSISDN', '000000000003');
...
$context->add_parameter('input_KycQueryType', 'Name');
