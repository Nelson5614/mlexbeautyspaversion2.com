                ...
                <div class="col-12">
                    <div class="page-title"> 
                        ...
                        <ul class="nav"> 
                            ...
                            <li><a href="{{ url('/body-services') }}">Body Services</a></li>
                            <li class="active">Body Service Details</li>
                        </ul> 
                    </div>
                </div>
            </div>
            ...
            <div class="row">
                <div class="col-lg-6">
                    ...
                    <div class="therapy-thumb mb-5 mb-lg-0">
                        <img src="{{ asset('storage/'.$bodyservices->image) }}"/>
                    </div>
                    <!-- End Therapy Thumb -->
                </div>
                <div class="col-lg-6">
                    ...
                    <div class="therapy-content">
                        <h2>{{ $bodyservices->title }}</h2>
                        <p>{{ $bodyservices->details }}</p>
            ...
            <div class="row">
                <div class="col-lg-6">
                    ...
                    <div class="therapy-content mb-5 mb-lg-0">
                        <h2>How does {{ $bodyservices->title }} work?</h2>
                        <p>{{ $bodyservices->descrption }}</p>
